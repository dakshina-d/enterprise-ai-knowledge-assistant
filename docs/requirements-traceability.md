...
| Retrieval authorization policy | Must | Backend security; [retrieval design](retrieval-design.md), [ADR 0005](adr/0005-rbac-enforcement-boundary.md) | Access-level plus `allowed_roles`, malformed metadata, and role-exclusion tests | Implemented | Pure policy tests only; retrieval remains planned |
